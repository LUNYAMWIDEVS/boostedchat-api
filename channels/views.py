...
class ChannelUserNameViewSet(viewsets.ViewSet):
    serializer_class = ChannelUserNameSerializer
    # def getChannelUserNameModel(self, channel):
    ...
    #         return InstagramUserNames
    #     return None
    # def getChannelManager(self, channel):
    #     if channel == "instagram":
    ...
    def create(self, request):
        ...
        if serializer.is_valid():
            ...
            try:
                LocalChannelManager.save_channel_username(validated_data)
                return Response({'message': 'Channel username created successfully', 'channel_username': validated_data["username"]}, status=status.HTTP_201_CREATED)
